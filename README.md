...
## <h4 align="center"> 
𝐀 𝐂𝐞𝐫𝐭𝐢𝐟𝐢𝐞𝐝 𝐂𝐲𝐛𝐞𝐫𝐬𝐞𝐜𝐮𝐫𝐢𝐭𝐲 Professional with 6+ years of experience securing digital assets in E-commerce, IT consulting, Research and Fashion-Tech. 

I specialize in threat detection, incident response, and real-time monitoring, vulnerability assessments, penetration testing, and audits aligned with 𝗜𝗦𝗢 𝟮𝟳𝟬𝟬𝟭, 𝗡𝗜𝗦𝗧, 𝗦𝗢𝗖 𝟮, 𝗛𝗜𝗣𝗔𝗔 𝗮𝗻𝗱 𝗣𝗖𝗜 𝗗𝗦𝗦. Adept in AWS, Azure, Google Cloud, Splunk, Nessus, Metasploit, and JIRA with a strong foundation in Zero Trust, encryption, malware analysis, and social engineering defense. Proven track record of enhancing security posture, ensuring compliance, and promoting secure innovation. 
